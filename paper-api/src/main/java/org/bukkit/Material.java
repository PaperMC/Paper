...
public enum Material implements Keyed, Translatable, net.kyori.adventure.translation.Translatable { // Paper
    ...
    BLACK_CONCRETE_SLAB(-1, Slab.class),
    BLACK_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    BLACK_WOOL(-1),
    BLACK_WOOL_SLAB(-1, Slab.class),
    BLACK_WOOL_STAIRS(-1, Stairs.class),
    BLACKSTONE(-1),
    ...
    BLUE_CONCRETE_SLAB(-1, Slab.class),
    BLUE_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    BLUE_WOOL(-1),
    BLUE_WOOL_SLAB(-1, Slab.class),
    BLUE_WOOL_STAIRS(-1, Stairs.class),
    ...
    BROWN_CONCRETE_SLAB(-1, Slab.class),
    BROWN_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    BROWN_WOOL(-1),
    BROWN_WOOL_SLAB(-1, Slab.class),
    BROWN_WOOL_STAIRS(-1, Stairs.class),
    ...
    CYAN_CONCRETE_SLAB(-1, Slab.class),
    CYAN_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    CYAN_WOOL(-1),
    CYAN_WOOL_SLAB(-1, Slab.class),
    CYAN_WOOL_STAIRS(-1, Stairs.class),
    ...
    GRAY_CONCRETE_SLAB(-1, Slab.class),
    GRAY_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    GRAY_WOOL(-1),
    GRAY_WOOL_SLAB(-1, Slab.class),
    GRAY_WOOL_STAIRS(-1, Stairs.class),
    ...
    GREEN_CONCRETE_SLAB(-1, Slab.class),
    GREEN_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    GREEN_WOOL(-1),
    GREEN_WOOL_SLAB(-1, Slab.class),
    GREEN_WOOL_STAIRS(-1, Stairs.class),
    ...
    LIGHT_BLUE_CONCRETE_SLAB(-1, Slab.class),
    LIGHT_BLUE_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    LIGHT_BLUE_WOOL(-1),
    LIGHT_BLUE_WOOL_SLAB(-1, Slab.class),
    LIGHT_BLUE_WOOL_STAIRS(-1, Stairs.class),
    ...
    LIGHT_GRAY_CONCRETE_SLAB(-1, Slab.class),
    LIGHT_GRAY_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    LIGHT_GRAY_WOOL(-1),
    LIGHT_GRAY_WOOL_SLAB(-1, Slab.class),
    LIGHT_GRAY_WOOL_STAIRS(-1, Stairs.class),
    ...
    LIME_CONCRETE_SLAB(-1, Slab.class),
    LIME_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    LIME_WOOL(-1),
    LIME_WOOL_SLAB(-1, Slab.class),
    LIME_WOOL_STAIRS(-1, Stairs.class),
    LODESTONE(-1),
    ...
    MAGENTA_CONCRETE_SLAB(-1, Slab.class),
    MAGENTA_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    MAGENTA_WOOL(-1),
    MAGENTA_WOOL_SLAB(-1, Slab.class),
    MAGENTA_WOOL_STAIRS(-1, Stairs.class),
    MAGMA_BLOCK(-1),
    ...
    ORANGE_CONCRETE_SLAB(-1, Slab.class),
    ORANGE_CONCRETE_STAIRS(-1, Stairs.class),
    ORANGE_GLAZED_TERRACOTTA(-1, Directional.class),
    ORANGE_POPLAR_LEAVES(-1, Leaves.class),
    ...
    ORANGE_WOOL(-1),
    ORANGE_WOOL_SLAB(-1, Slab.class),
    ORANGE_WOOL_STAIRS(-1, Stairs.class),
    OXEYE_DAISY(-1),
    ...
    PINK_CONCRETE_SLAB(-1, Slab.class),
    PINK_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    PINK_WOOL(-1),
    PINK_WOOL_SLAB(-1, Slab.class),
    PINK_WOOL_STAIRS(-1, Stairs.class),
    ...
    POPLAR_BUTTON(-1, Switch.class),
    POPLAR_DOOR(-1, Door.class),
    POPLAR_FENCE(-1, Fence.class),
    POPLAR_FENCE_GATE(-1, Gate.class),
    POPLAR_HANGING_SIGN(-1, HangingSign.class),
    POPLAR_LOG(-1, Orientable.class),
    POPLAR_PLANKS(-1),
    POPLAR_PRESSURE_PLATE(-1, Powerable.class),
    POPLAR_SAPLING(-1, Sapling.class),
    POPLAR_SHELF(-1, Shelf.class),
    POPLAR_SIGN(-1, Sign.class),
    POPLAR_SLAB(-1, Slab.class),
    POPLAR_STAIRS(-1, Stairs.class),
    POPLAR_TRAPDOOR(-1, TrapDoor.class),
    POPLAR_WALL_HANGING_SIGN(-1, WallHangingSign.class),
    POPLAR_WALL_SIGN(-1, WallSign.class),
    POPLAR_WOOD(-1, Orientable.class),
    POPPY(-1),
    ...
    PURPLE_CONCRETE_SLAB(-1, Slab.class),
    PURPLE_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    PURPLE_WOOL(-1),
    PURPLE_WOOL_SLAB(-1, Slab.class),
    PURPLE_WOOL_STAIRS(-1, Stairs.class),
    PURPUR_BLOCK(-1),
    ...
    RED_CONCRETE_SLAB(-1, Slab.class),
    RED_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    RED_NETHER_BRICKS(-1),
    RED_POPLAR_LEAVES(-1, Leaves.class),
    RED_SAND(-1),
    RED_SANDSTONE(-1),
    ...
    RED_WOOL(-1),
    RED_WOOL_SLAB(-1, Slab.class),
    RED_WOOL_STAIRS(-1, Stairs.class),
    REDSTONE_BLOCK(-1),
    ...
    STRIPPED_POPLAR_LOG(-1, Orientable.class),
    STRIPPED_POPLAR_WOOD(-1, Orientable.class),
    ...
    WHITE_CONCRETE_SLAB(-1, Slab.class),
    WHITE_CONCRETE_STAIRS(-1, Stairs.class),
    ...
    WHITE_WOOL(-1),
    WHITE_WOOL_SLAB(-1, Slab.class),
    WHITE_WOOL_STAIRS(-1, Stairs.class),
    ...
    YELLOW_CONCRETE_SLAB(-1, Slab.class),
    YELLOW_CONCRETE_STAIRS(-1, Stairs.class),
    YELLOW_GLAZED_TERRACOTTA(-1, Directional.class),
    YELLOW_POPLAR_LEAVES(-1, Leaves.class),
    ...
    YELLOW_WOOL(-1),
    YELLOW_WOOL_SLAB(-1, Slab.class),
    YELLOW_WOOL_STAIRS(-1, Stairs.class),
