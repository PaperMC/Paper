...
public class PlayerDeathEvent extends EntityDeathEvent {
    ...
    public PlayerDeathEvent(final @NotNull Player player, final @NotNull DamageSource damageSource, final @NotNull List<ItemStack> drops, final int droppedExp, final @Nullable Component deathMessage) {
        this(player, damageSource, drops, droppedExp, 0, true, deathMessage);
    }

    @org.jetbrains.annotations.ApiStatus.Internal
    public PlayerDeathEvent(final @NotNull Player player, final @NotNull DamageSource damageSource, final @NotNull List<ItemStack> drops, final int droppedExp, final boolean displayDeathMessage, final @Nullable Component deathMessage) {
        this(player, damageSource, drops, droppedExp, 0, displayDeathMessage, deathMessage);
    }
    ...
    public PlayerDeathEvent(@NotNull final Player player, final @NotNull DamageSource damageSource, @NotNull final List<ItemStack> drops, final int droppedExp, final int newExp, final int newTotalExp, final int newLevel, @Nullable final String deathMessage, boolean doExpDrop) {
        ...
        this.deathChatMessage = LegacyComponentSerializer.legacySection().deserializeOrNull(deathMessage); // Paper
     ...
     * @see #deathScreenMessage()
     */
    public void setShouldDisplayDeathMessage(boolean displayDeathMessage) {
        this.displayDeathMessage = displayDeathMessage;
    }
     ...
     * @deprecated in favour of {@link #deathChatMessage(Component)} and {@link #deathScreenMessage(Component)}
     */
    @Deprecated
