...
public class ClockTimeSkipEvent extends Event implements Cancellable {
    ...
    @ApiStatus.Internal
    public ClockTimeSkipEvent(@NotNull WorldClock clock, @NotNull SkipReason skipReason, long skipAmount) {
        this.clock = clock;
    ...
    /**
     * Gets the clock whose time is changing.
     *
     * @return the clock, or null if the change does not target a specific clock
     */
    @NotNull
