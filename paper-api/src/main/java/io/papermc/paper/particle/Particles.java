...
public final class Particles {
    ...
    public static final ParticleType.NonValued SULFUR_BUBBLES = unvalued("sulfur_bubbles");
    public static final ParticleType.NonValued NOXIOUS_GAS = unvalued("noxious_gas");
    public static final ParticleType.NonValued NOXIOUS_GAS_CLOUD = unvalued("noxious_gas_cloud");
    public static final ParticleType.Valued<Particle.Geyser> GEYSER = valued("geyser");
    public static final ParticleType.Valued<Particle.GeyserBase> GEYSER_BASE = valued("geyser_base");
    public static final ParticleType.Valued<Particle.GeyserBase> GEYSER_POOF = valued("geyser_poof");
    public static final ParticleType.Valued<Particle.Geyser> GEYSER_PLUME = valued("geyser_plume");
    ...
    public static final ParticleType.NonValued PAUSE_MOB_GROWTH = unvalued("pause_mob_growth");
    public static final ParticleType.NonValued RESET_MOB_GROWTH = unvalued("reset_mob_growth");
    ...
    public static final ParticleType.NonValued SULFUR_CUBE_GOO = unvalued("sulfur_cube_goo");

    private static ParticleType.NonValued unvalued(@KeyPattern.Value final String name) {
        final ParticleType type = Registry.PARTICLE_TYPE.getOrThrow(Key.key(Key.MINECRAFT_NAMESPACE, name));
        if (type instanceof ParticleType.NonValued unvalued) {
            return unvalued;
        }
        throw new IllegalStateException(name + " is not a valid unvalued type, it is a " + type.getClass().getTypeName());
    }

    @SuppressWarnings("unchecked")
    private static <T> ParticleType.Valued<T> valued(@KeyPattern.Value final String name) {
        final ParticleType type = Registry.PARTICLE_TYPE.getOrThrow(Key.key(Key.MINECRAFT_NAMESPACE, name));
        if (type instanceof ParticleType.Valued) {
            return (ParticleType.Valued<T>) type;
        }
        throw new IllegalStateException(name + " is not a valid valued type, it is a " + type.getClass().getTypeName());
    }
