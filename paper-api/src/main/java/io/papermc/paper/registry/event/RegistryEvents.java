...
public final class RegistryEvents {
    ...
    public static final RegistryEventProvider<PotPatternType, PotPatternRegistryEntry.Builder> DECORATED_POT_PATTERN = create(RegistryKey.DECORATED_POT_PATTERN);
