...
public sealed interface SpawnCondition permits SpawnCondition.BiomeCheck, SpawnCondition.MoonBrightnessCheck, SpawnCondition.StructureCheck {
     ...
     *
     * @param min The minimum moon brightness, or null if there is no minimum
     * @param max The maximum moon brightness, or null if there is no maximum
     * @return The moon brightness check condition
     */
    @Contract(pure = true, value = "_, _ -> new")
    static SpawnCondition moonBrightnessCheck(final @Nullable Double min, final @Nullable Double max) {
