...
public sealed interface DialogInputConfig permits BooleanDialogInputConfig, NumberRangeDialogInputConfig, SingleOptionDialogInputConfig, TextDialogInputConfig {
    ...
    /**
     * Creates a new builder for a boolean dialog input configuration.
     *
     * @param label the label for the input
     * @return a new builder instance
     */
    @Contract(pure = true, value = "_ -> new")
    static BooleanDialogInputConfig.Builder bool(final Component label) {
        return new BooleanDialogInputConfigImpl.BuilderImpl(label);
    }
    ...
    static NumberRangeDialogInputConfig.Builder numberRange(final Component label, final float start, final float end) {
    ...
    /**
     * Creates a new builder for a single option dialog input configuration.
     *
     * @param label the label for the input
     * @param entries the list of options for the input
     * @return a new builder instance
    ...
    static SingleOptionDialogInputConfig.Builder singleOption(final Component label, final List<SingleOptionDialogInputConfig.OptionEntry> entries) {
        return new SingleOptionDialogInputConfigImpl.BuilderImpl(entries, label);
    }
    ...
    /**
     * Creates a new builder for a text dialog input configuration.
     *
     * @param label the label for the input
     * @return a new builder instance
     */
    @Contract(value = "_ -> new", pure = true)
    static TextDialogInputConfig.Builder text(final Component label) {
        return new TextDialogInputConfigImpl.BuilderImpl(label);
    }
}
