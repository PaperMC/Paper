...
public final class LootTables {
    ...
    public static final LootTable BLOCKS_CHISELED_CINNABAR = getTable("blocks/chiseled_cinnabar");
    ...
    public static final LootTable BLOCKS_CHISELED_SULFUR = getTable("blocks/chiseled_sulfur");
    ...
    public static final LootTable BLOCKS_CINNABAR = getTable("blocks/cinnabar");

    public static final LootTable BLOCKS_CINNABAR_BRICK_SLAB = getTable("blocks/cinnabar_brick_slab");

    public static final LootTable BLOCKS_CINNABAR_BRICK_STAIRS = getTable("blocks/cinnabar_brick_stairs");

    public static final LootTable BLOCKS_CINNABAR_BRICK_WALL = getTable("blocks/cinnabar_brick_wall");

    public static final LootTable BLOCKS_CINNABAR_BRICKS = getTable("blocks/cinnabar_bricks");

    public static final LootTable BLOCKS_CINNABAR_SLAB = getTable("blocks/cinnabar_slab");

    public static final LootTable BLOCKS_CINNABAR_STAIRS = getTable("blocks/cinnabar_stairs");

    public static final LootTable BLOCKS_CINNABAR_WALL = getTable("blocks/cinnabar_wall");
    ...
    public static final LootTable BLOCKS_GOLDEN_DANDELION = getTable("blocks/golden_dandelion");
    ...
    public static final LootTable BLOCKS_POLISHED_CINNABAR = getTable("blocks/polished_cinnabar");

    public static final LootTable BLOCKS_POLISHED_CINNABAR_SLAB = getTable("blocks/polished_cinnabar_slab");

    public static final LootTable BLOCKS_POLISHED_CINNABAR_STAIRS = getTable("blocks/polished_cinnabar_stairs");

    public static final LootTable BLOCKS_POLISHED_CINNABAR_WALL = getTable("blocks/polished_cinnabar_wall");
    ...
    public static final LootTable BLOCKS_POLISHED_SULFUR = getTable("blocks/polished_sulfur");

    public static final LootTable BLOCKS_POLISHED_SULFUR_SLAB = getTable("blocks/polished_sulfur_slab");

    public static final LootTable BLOCKS_POLISHED_SULFUR_STAIRS = getTable("blocks/polished_sulfur_stairs");

    public static final LootTable BLOCKS_POLISHED_SULFUR_WALL = getTable("blocks/polished_sulfur_wall");
    ...
    public static final LootTable BLOCKS_POTENT_SULFUR = getTable("blocks/potent_sulfur");
    ...
    public static final LootTable BLOCKS_POTTED_GOLDEN_DANDELION = getTable("blocks/potted_golden_dandelion");
    ...
    public static final LootTable BLOCKS_SULFUR = getTable("blocks/sulfur");

    public static final LootTable BLOCKS_SULFUR_BRICK_SLAB = getTable("blocks/sulfur_brick_slab");

    public static final LootTable BLOCKS_SULFUR_BRICK_STAIRS = getTable("blocks/sulfur_brick_stairs");

    public static final LootTable BLOCKS_SULFUR_BRICK_WALL = getTable("blocks/sulfur_brick_wall");

    public static final LootTable BLOCKS_SULFUR_BRICKS = getTable("blocks/sulfur_bricks");

    public static final LootTable BLOCKS_SULFUR_SLAB = getTable("blocks/sulfur_slab");

    public static final LootTable BLOCKS_SULFUR_SPIKE = getTable("blocks/sulfur_spike");

    public static final LootTable BLOCKS_SULFUR_STAIRS = getTable("blocks/sulfur_stairs");

    public static final LootTable BLOCKS_SULFUR_WALL = getTable("blocks/sulfur_wall");
    ...
    public static final LootTable ENTITIES_SULFUR_CUBE = getTable("entities/sulfur_cube");
