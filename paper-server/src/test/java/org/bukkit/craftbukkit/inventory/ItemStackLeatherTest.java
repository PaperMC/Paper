...
public class ItemStackLeatherTest extends ItemStackTest {
    ...
    public static Stream<Arguments> data() {
        return ItemProvider.compound(ItemStackLeatherTest.operators(), "%s %s", NAME_PARAMETER, Material.LEATHER_BOOTS, Material.LEATHER_CHESTPLATE, Material.LEATHER_HELMET, Material.LEATHER_LEGGINGS);
    }
