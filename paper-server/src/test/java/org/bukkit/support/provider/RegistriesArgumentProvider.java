...
public class RegistriesArgumentProvider implements ArgumentsProvider {
    ...
    static {
        ...
        register(Registries.CHICKEN_SOUND_VARIANT, Chicken.SoundVariant.class, CraftChicken.CraftSoundVariant.class, ChickenSoundVariant.class);
        register(Registries.COW_VARIANT, Cow.Variant.class, CraftCow.CraftVariant.class, CowVariant.class);
        register(Registries.COW_SOUND_VARIANT, Cow.SoundVariant.class, CraftCow.CraftSoundVariant.class, CowSoundVariant.class);
        register(Registries.PIG_VARIANT, Pig.Variant.class, CraftPig.CraftVariant.class, PigVariant.class);
        register(Registries.PIG_SOUND_VARIANT, Pig.SoundVariant.class, CraftPig.CraftSoundVariant.class, PigSoundVariant.class);
        ...
        register(Registries.BLOCK_TRANSFORMER, BlockTransformer.class, BlockTransformers.class, PaperBlockTransformer.class, net.minecraft.core.component.BlockTransformer.class);
    }
