...
public class RegistriesArgumentProvider implements ArgumentsProvider {
    ...
    static {
        ...
        register(RegistryKey.ZOMBIE_NAUTILUS_VARIANT, ZombieNautilus.Variant.class, Registries.ZOMBIE_NAUTILUS_VARIANT, CraftZombieNautilus.CraftVariant.class, ZombieNautilusVariant.class);
