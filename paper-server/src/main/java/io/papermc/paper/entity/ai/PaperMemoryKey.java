...
import static io.papermc.paper.registry.typed.converter.Converters.entity;
...
public class PaperMemoryKey<A, M> extends HolderableBase<MemoryModuleType<M>> implements MemoryKey {
    ...
    private static final PaperTypedDataAdapters<MemoryModuleType<?>> ADAPTERS = PaperTypedDataAdapters.<MemoryModuleType<?>, TypedDataCollector.Unvaluable<MemoryModuleType<?>>>create(
