...
public class PaperBiomeClimate implements BiomeClimate {
    ...
    public PaperBiomeClimate(final Biome.ClimateSettings climate, final Biome biome) {
    ...
    public float adjustedTemperature(final Location location) {
        ...
        return this.biome.getHeightAdjustedTemperature(CraftLocation.toBlockPos(location), location.getWorld().getSeaLevel());
    }
}
