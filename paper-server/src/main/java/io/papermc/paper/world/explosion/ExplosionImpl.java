...
public record ExplosionImpl(
    ...
    @Nullable Explosion.DamageCalculator damageCalculator) implements Explosion {
    ...
    public static class Builder implements Explosion.Builder {
        ...
        public Builder damageProvider(@Nullable Explosion.DamageCalculator damageCalculator) {
