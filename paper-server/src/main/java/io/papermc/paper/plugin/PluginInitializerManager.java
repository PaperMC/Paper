...
public class PluginInitializerManager {
    ...
    public static void load(OptionSet optionSet) throws Exception {
        ...
        dirs.forEach(pluginDir -> io.papermc.paper.plugin.util.EntrypointUtil.registerProvidersFromSource(io.papermc.paper.plugin.provider.source.DirectoryProviderSource.INSTANCE, pluginDir));
