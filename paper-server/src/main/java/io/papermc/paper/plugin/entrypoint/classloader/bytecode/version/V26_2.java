...
public class V26_2 extends VersionedClassloaderBytecodeModifier {

    public static final ApiVersion VERSION = ApiVersion.getOrCreateVersion("26.2");

    private static final Map<Class<?>, Class<?>> REGISTRY_TYPES_TO_INTERFACES = Map.of(
        PotionType.class, CraftPotionType.class
    );

    public V26_2(final int api) {
        super(api);
    }
