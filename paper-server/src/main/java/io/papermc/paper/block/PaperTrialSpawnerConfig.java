...
public class PaperTrialSpawnerConfig extends HolderableBase<TrialSpawnerConfig> implements io.papermc.paper.block.TrialSpawnerConfig {
    ...
    public static TrialSpawnerConfig bukkitToMinecraft(final io.papermc.paper.block.TrialSpawnerConfig config) {
        return CraftRegistry.bukkitToMinecraft(config);
    }

    public static io.papermc.paper.block.TrialSpawnerConfig minecraftToBukkit(final TrialSpawnerConfig config) {
        return CraftRegistry.minecraftToBukkit(config, Registries.TRIAL_SPAWNER_CONFIG);
    }

    public static Holder<TrialSpawnerConfig> bukkitToMinecraftHolder(final io.papermc.paper.block.TrialSpawnerConfig config) {
        return CraftRegistry.bukkitToMinecraftHolder(config, Registries.TRIAL_SPAWNER_CONFIG);
    }
