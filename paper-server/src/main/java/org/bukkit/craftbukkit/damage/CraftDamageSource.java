...
public class CraftDamageSource implements DamageSource {
    ...
    public static DamageSource buildFromBukkit(DamageType damageType, Entity causingEntity, Entity directEntity, Location damageLocation, DamageContext damageContext) {
