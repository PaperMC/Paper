...
@NullMarked
public class CraftPotionEffectType extends PotionEffectType implements HolderableElement<MobEffect, PotionEffectType>, io.papermc.paper.world.flag.PaperFeatureDependent<MobEffect> {
