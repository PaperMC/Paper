...
public final class CraftEntityTypes {
    ...
    static {
        ...
        // Move (boats)
        register(new EntityTypeData<>(EntityType.ACACIA_BOAT, Boat.class, CraftBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.ACACIA_BOAT)));
        register(new EntityTypeData<>(EntityType.ACACIA_CHEST_BOAT, ChestBoat.class, CraftChestBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.ACACIA_CHEST_BOAT)));
        register(new EntityTypeData<>(EntityType.BIRCH_BOAT, Boat.class, CraftBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.BIRCH_BOAT)));
        register(new EntityTypeData<>(EntityType.BIRCH_CHEST_BOAT, ChestBoat.class, CraftChestBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.BIRCH_CHEST_BOAT)));
        register(new EntityTypeData<>(EntityType.CHERRY_BOAT, Boat.class, CraftBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.CHERRY_BOAT)));
        register(new EntityTypeData<>(EntityType.CHERRY_CHEST_BOAT, ChestBoat.class, CraftChestBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.CHERRY_CHEST_BOAT)));
        register(new EntityTypeData<>(EntityType.DARK_OAK_BOAT, Boat.class, CraftBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.DARK_OAK_BOAT)));
        register(new EntityTypeData<>(EntityType.DARK_OAK_CHEST_BOAT, ChestBoat.class, CraftChestBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.DARK_OAK_CHEST_BOAT)));
        register(new EntityTypeData<>(EntityType.JUNGLE_BOAT, Boat.class, CraftBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.JUNGLE_BOAT)));
        register(new EntityTypeData<>(EntityType.JUNGLE_CHEST_BOAT, ChestBoat.class, CraftChestBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.JUNGLE_CHEST_BOAT)));
        register(new EntityTypeData<>(EntityType.MANGROVE_BOAT, Boat.class, CraftBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.MANGROVE_BOAT)));
        register(new EntityTypeData<>(EntityType.MANGROVE_CHEST_BOAT, ChestBoat.class, CraftChestBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.MANGROVE_CHEST_BOAT)));
        register(new EntityTypeData<>(EntityType.OAK_BOAT, Boat.class, CraftBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.OAK_BOAT)));
        register(new EntityTypeData<>(EntityType.OAK_CHEST_BOAT, ChestBoat.class, CraftChestBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.OAK_CHEST_BOAT)));
        register(new EntityTypeData<>(EntityType.PALE_OAK_BOAT, Boat.class, CraftBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.PALE_OAK_BOAT)));
        register(new EntityTypeData<>(EntityType.PALE_OAK_CHEST_BOAT, ChestBoat.class, CraftChestBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.PALE_OAK_CHEST_BOAT)));
        register(new EntityTypeData<>(EntityType.SPRUCE_BOAT, Boat.class, CraftBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.SPRUCE_BOAT)));
        register(new EntityTypeData<>(EntityType.SPRUCE_CHEST_BOAT, ChestBoat.class, CraftChestBoat::new, createAndMove(net.minecraft.world.entity.EntityTypes.SPRUCE_CHEST_BOAT)));
        register(new EntityTypeData<>(EntityType.BAMBOO_RAFT, Raft.class, CraftRaft::new, createAndMove(net.minecraft.world.entity.EntityTypes.BAMBOO_RAFT)));
        register(new EntityTypeData<>(EntityType.BAMBOO_CHEST_RAFT, ChestRaft.class, CraftChestRaft::new, createAndMove(net.minecraft.world.entity.EntityTypes.BAMBOO_CHEST_RAFT)));
    ...
    private static void register(EntityTypeData<?, ?> typeData) {
        ...
        // CraftEntityTypes.CLASS_TYPE_DATA.put(typeData.entityClass(), typeData); TODO remove once asm migration is done for boats
    }
